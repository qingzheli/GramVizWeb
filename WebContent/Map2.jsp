...
<body>
	...
	<div id="map2" style="width: 1900px; height: 500px"></div>
	...
	<script>
		...
		var map2 = L.map('map2').setView(lat2[0], 13);
		...
		}).addTo(map).bindPopup("I am step 7.");
...
}).addTo(map2).bindPopup("I am step 1.");
...
}).addTo(map2).bindPopup("I am step 2.");
...
}).addTo(map2).bindPopup("I am step 3.");
...
}).addTo(map2).bindPopup("I am step 4.");
...
}).addTo(map2).bindPopup("I am step 5.");
...
}).addTo(map2).bindPopup("I am step 6.");
